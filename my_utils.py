...
if __name__ == '__main__':
    ...
    state_dict = torch.load('weights/best14x.pt') #model_prunned/yolov3_0.1_config_yolov3_v00_column.pt
    ...
    # yaml_sparsity_calculator(model,filename1='config_csdarknet53pan_v16')
